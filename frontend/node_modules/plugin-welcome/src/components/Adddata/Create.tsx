          ...
          <Grid container alignItems="center" spacing={4}>
            ...
            <Grid item xs={2}>
              <Typography color="primary" variant="h6" component="h1">
                <font color="06d6a0">ชื่อแพทย์</font>
              </Typography>
            </Grid>
            <Grid item xs={2}>
            ...
            <Grid item xs={2}>
              <Typography color="primary" variant="h6" component="h1">
              <font color="06d6a0">ชื่อเครื่องมือแพทย์</font>
              </Typography>
            </Grid>
            <Grid item xs={2}>
            ...
            <Grid item xs={2}>
              <Typography color="primary" variant="h6" component="h1">
              <font color="06d6a0">ประเภทของอุปกรณ์</font>
              </Typography>
            </Grid>
            <Grid item xs={2}>
            ...
            <Grid item xs={2}>
              <Typography color="primary" variant="h6" component="h1">
              <font color="06d6a0">จำนวน/ชิ้น</font>
              </Typography>
            </Grid>
            <Grid item xs={2}>
            <Paper >
            ...
            <Grid item xs={2}>
              <Typography color="primary" variant="h6" component="h1">
              <font color="06d6a0">วันที่/เวลาที่บันทึก</font>
              </Typography>
            </Grid>
            <Grid item xs={2}>
               <form  noValidate>
